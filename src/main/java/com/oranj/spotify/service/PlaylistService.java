package com.oranj.spotify.service;

import com.oranj.spotify.model.*;
...
public class PlaylistService {
    ...
    public OranjResponse getTrackData(String trackId) {
        ...
        OranjResponse oranjResponse = restTemplate.getForObject("https://kkuwbyropc.execute-api.us-east-1.amazonaws.com/internexam",OranjResponse.class);
        return oranjResponse;
    }
